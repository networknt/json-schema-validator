...
public class NetworkntTestSuiteOptionalBenchmark {
    ...
    public static class BenchmarkState {
        ...
        private Callable<Object> draft202012Optional = new NetworkntTestSuiteRunner(
                NetworkntTestSuiteTestCases.findTestCases(SpecificationVersion.DRAFT_2020_12, "src/test/suite/tests/draft2020-12",
                        TestCaseFilter.optionalType()));
        private Callable<Object> draft201909Optional = new NetworkntTestSuiteRunner(
                NetworkntTestSuiteTestCases.findTestCases(SpecificationVersion.DRAFT_2019_09, "src/test/suite/tests/draft2019-09",
                        TestCaseFilter.optionalType()));
        private Callable<Object> draft7Optional = new NetworkntTestSuiteRunner(NetworkntTestSuiteTestCases
                .findTestCases(SpecificationVersion.DRAFT_7, "src/test/suite/tests/draft7", TestCaseFilter.optionalType()));
        private Callable<Object> draft6Optional = new NetworkntTestSuiteRunner(NetworkntTestSuiteTestCases
                .findTestCases(SpecificationVersion.DRAFT_6, "src/test/suite/tests/draft6", TestCaseFilter.optionalType()));
        private Callable<Object> draft4Optional = new NetworkntTestSuiteRunner(NetworkntTestSuiteTestCases
                .findTestCases(SpecificationVersion.DRAFT_4, "src/test/suite/tests/draft4", TestCaseFilter.optionalType()));
