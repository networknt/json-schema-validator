...
class JsonSchemaTestSuiteTest extends AbstractJsonSchemaTestSuite {
    ...
    Stream<DynamicNode> draft2022012() {
        return createTests(SpecificationVersion.DRAFT_2020_12, "src/test/suite/tests/draft2020-12");
    }

    @TestFactory
    @DisplayName("Draft 2019-09")
    Stream<DynamicNode> draft201909() {
        return createTests(SpecificationVersion.DRAFT_2019_09, "src/test/suite/tests/draft2019-09");
    }

    @TestFactory
    @DisplayName("Draft 7")
    Stream<DynamicNode> draft7() {
        return createTests(SpecificationVersion.DRAFT_7, "src/test/suite/tests/draft7");
    }

    @TestFactory
    @DisplayName("Draft 6")
    Stream<DynamicNode> draft6() {
        return createTests(SpecificationVersion.DRAFT_6, "src/test/suite/tests/draft6");
    }

    @TestFactory
    @DisplayName("Draft 4")
    Stream<DynamicNode> draft4() {
        return createTests(SpecificationVersion.DRAFT_4, "src/test/suite/tests/draft4");
    }
