...
class CustomMessageTest extends AbstractJsonSchemaTestSuite {
    ...
    Stream<DynamicNode> draft201909__customMessagesEnabled() {
        return createTests(SpecificationVersion.DRAFT_2019_09, "src/test/resources/schema/customMessageTests/custom-message-tests.json");
    }

    @TestFactory
    @DisplayName("Draft 2019-09 - Custom Messages Disabled")
    Stream<DynamicNode> draft201909__customMessagesDisabled() {
        return createTests(SpecificationVersion.DRAFT_2019_09, "src/test/resources/schema/customMessageTests/custom-message-disabled-tests.json");
    }
