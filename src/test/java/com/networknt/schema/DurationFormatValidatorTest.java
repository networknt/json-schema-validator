...
class DurationFormatValidatorTest {
    ...
    void durationFormatValidatorTest() throws IOException {
        ...
        final SchemaRegistry validatorFactory = SchemaRegistry.builder(SchemaRegistry.withDefaultDialect(Specification.Version.DRAFT_2019_09)).build();
        ...
        messages = validatorSchema.validate(invalidTargetNode, OutputFormat.DEFAULT, (executionContext, schemaContext) -> {
