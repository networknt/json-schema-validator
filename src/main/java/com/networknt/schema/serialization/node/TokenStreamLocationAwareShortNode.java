...
/**
 * {@link ShortNode} that is {@link TokenStreamLocationAware}.
 */
public class TokenStreamLocationAwareShortNode extends ShortNode implements TokenStreamLocationAware {
    /**
     * 
     */
    ...
    public TokenStreamLocationAwareShortNode(short v, TokenStreamLocation tokenStreamLocation) {
        super(v);
