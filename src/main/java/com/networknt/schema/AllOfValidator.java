...
public class AllOfValidator extends BaseJsonValidator {
    ...
    public AllOfValidator(JsonNodePath schemaPath, JsonNodePath validationPath, JsonNode schemaNode, JsonSchema parentSchema, ValidationContext validationContext) {
        super(schemaPath, validationPath, schemaNode, parentSchema, ValidatorTypeCode.ALL_OF, validationContext);
