...
public class FalseValidator extends BaseJsonValidator implements JsonValidator {
    ...
    public FalseValidator(JsonNodePath schemaPath, JsonNodePath evaluationPath, final JsonNode schemaNode, JsonSchema parentSchema, ValidationContext validationContext) {
        super(schemaPath, evaluationPath, schemaNode, parentSchema, ValidatorTypeCode.FALSE, validationContext);
    }
