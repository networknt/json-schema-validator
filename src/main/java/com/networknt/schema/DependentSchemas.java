...
public class DependentSchemas extends BaseJsonValidator {
    ...
    public DependentSchemas(JsonNodePath schemaPath, JsonNode schemaNode, JsonSchema parentSchema, ValidationContext validationContext) {
        ...
        for (Iterator<String> it = schemaNode.fieldNames(); it.hasNext(); ) {
            ...
            if (pvalue.isObject() || pvalue.isBoolean()) {
                this.schemaDependencies.put(pname, validationContext.newSchema(schemaPath.resolve(pname), pvalue, parentSchema));
            }
        }
