...
public class JsonMetaSchema {
    ...
    public JsonValidator newValidator(ValidationContext validationContext, JsonNodePath schemaPath, JsonNodePath validationPath, String keyword /* keyword */, JsonNode schemaNode,
        ...
        try {
            ...
            return kw.newValidator(schemaPath, validationPath, schemaNode, parentSchema, validationContext);
