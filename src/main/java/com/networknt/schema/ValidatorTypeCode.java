...
public enum ValidatorTypeCode implements Keyword, ErrorMessageType {
    ...
    FORMAT("format", "1009", null, VersionCode.AllVersions) {
        @Override public JsonValidator newValidator(JsonNodePath schemaPath, JsonNodePath evaluationPath, JsonNode schemaNode, JsonSchema parentSchema, ValidationContext validationContext) {
    ...
    @Override
    public JsonValidator newValidator(JsonNodePath schemaPath, JsonNodePath evaluationPath, JsonNode schemaNode, JsonSchema parentSchema, ValidationContext validationContext) throws Exception {
        ...
        return c.newInstance(schemaPath.resolve(getValue()), evaluationPath.resolve(getValue()), schemaNode,
