...
public enum ValidatorTypeCode implements Keyword, ErrorMessageType {
    ...
    @Override
    public JsonValidator newValidator(JsonNodePath schemaLocation, JsonNodePath evaluationPath, JsonNode schemaNode, JsonSchema parentSchema, ValidationContext validationContext) throws Exception {
        ...
        return c.newInstance(schemaLocation.resolve(getValue()), evaluationPath.resolve(getValue()), schemaNode,
