...
public class NotAllowedValidator extends BaseJsonValidator implements JsonValidator {
    ...
    public NotAllowedValidator(JsonNodePath schemaPath, JsonNodePath validationPath, JsonNode schemaNode, JsonSchema parentSchema, ValidationContext validationContext) {

        super(schemaPath, validationPath, schemaNode, parentSchema, ValidatorTypeCode.NOT_ALLOWED, validationContext);
