...
## Warning!! Before you proceed, this is an experimental repository to try out implementing lightweight JODD based JSON Library (http://jodd.json.org) instead of jackson library, for using JsonSchemaValidator go to original repository by original contributors https://github.com/networknt/json-schema-validator. 
