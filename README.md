...
## Warning!! Before you progress, This is experimental repository to try out implementing lightweight JODD based JSON Library (http://jodd.json.org) instead of jackson library, for using JsonSchemaValidator go to original repository https://github.com/networknt/json-schema-validator
